...
set(Qt5Multimedia_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.15.0"
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.15.0/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Multimedia)
    ...
    set_property(TARGET Qt5::Multimedia
                 ...
                 alsa;linux_v4l;pulseaudio)
    set_property(TARGET Qt5::Multimedia
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 directshow;evr;gpu_vivante;gstreamer_1_0;gstreamer_0_10;gstreamer;gstreamer_app;gstreamer_encodingprofiles;gstreamer_gl;gstreamer_imxcommon;gstreamer_photography;openal;resourcepolicy;wasapi;wmf;wmsdk;wshellitem)
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.15.0" "" FALSE)
