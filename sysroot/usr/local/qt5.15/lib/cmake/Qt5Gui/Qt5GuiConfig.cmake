...
set(Qt5Gui_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.0"
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.0/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Gui)
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 angle;combined-angle-lib;dynamicgl;openvg)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 xkbcommon;xkbcommon-x11;xcb;drm_atomic;egl;eglfs;eglfs_brcm;kms;eglfs_gbm;xlib;xcb-xlib;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;jpeg;libinput;libinput-axis-api;linuxfb;mtdev;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-xcb-xinput;tuiotouch;vkgen;vnc)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 accessibility-atspi-bridge;dxguid;angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;dxgi1_2;egl_x11;eglfs_egldevice;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;vsp2;eglfs_vsp2;eglfs_x11;integrityfb;integrityhid;system-png;tslib;xcb-egl-plugin;xcb-glx-plugin;xcb-native-painting;xcb-sm)
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.0" "" FALSE)
